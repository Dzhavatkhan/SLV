...
var kc = class _kc extends ft {
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      const e = _kc.getOrCreateInstance(this);
      t === "toggle" && e[t]();
    });
  }
};
...
var da = "show";
var ap = "[data-te-offcanvas-init][data-te-offcanvas-show]";
var lp = `show${oi}`;
var cp = `shown${oi}`;
var hp = `hide${oi}`;
var dp = `hidden${oi}`;
var up = `keydown.dismiss${oi}`;
var js = class _js extends ft {
  constructor(t, e) {
  ...
  show(t) {
    if (this._isShown || c.trigger(this._element, lp, {
      ...
      return;
    this._isShown = true, this._element.style.visibility = "visible", this._backdrop.show(), this._config.scroll || new ti().hide(), this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", true), this._element.setAttribute("role", "dialog"), this._element.setAttribute(`data-te-offcanvas-${da}`, "");
    const i = () => {
  ...
  hide() {
    if (!this._isShown || c.trigger(this._element, hp).defaultPrevented)
      return;
    this._focustrap.disable(), this._element.blur(), this._isShown = false, this._element.removeAttribute(`data-te-offcanvas-${da}`), this._backdrop.hide();
    const e = () => {
      this._element.setAttribute("aria-hidden", true), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._element.style.visibility = "hidden", this._config.scroll || new ti().reset(), c.trigger(this._element, dp);
    };
  ...
  _init() {
    this._didInit || (c.on(
      ...
      np,
      () => d.find(ap).forEach(
        (t) => _js.getOrCreateInstance(t).show()
      )
    ), this._didInit = true, vn(_js));
  }
  _getConfig(t) {
    return t = {
      ...ha,
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      const e = _js.getOrCreateInstance(this, t);
      if (typeof t == "string") {
...
var Ko = class _Ko extends ft {
  ...
  // Private
  _init() {
    this._didInit || (vn(_Ko, "close"), this._didInit = true);
  }
  _getConfig(t) {
    return t = {
      ...ua,
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      const e = _Ko.getOrCreateInstance(this);
      if (typeof t == "string") {
        if (e[t] === void 0 || t.startsWith("_") || t === "constructor")
          throw new TypeError(`No method named "${t}"`);
        e[t](this);
...
var zo = class _zo extends ft {
  ...
  show(t) {
    this._isShown || this._isTransitioning || c.trigger(this._element, o_, {
      relatedTarget: t
    }).defaultPrevented || (this._isShown = true, this._isAnimated() && (this._isTransitioning = true), !this._config.modalNonInvasive && this._scrollBar.hide(), document.body.setAttribute(Ea, "true"), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), c.on(this._dialog, Ta, () => {
  ...
  hide() {
    ...
    e && (this._isTransitioning = true), this._setEscapeEvent(), this._setResizeEvent(), this._focustrap.disable(), d.findOne(pi, this._element).classList.remove(this._classes.show), c.off(this._element, ba), c.off(this._dialog, Ta), this._queueCallback(() => this._hideModal(), this._element, e), this._element.removeAttribute(Ca);
  }
  dispose() {
  ...
  // Private
  _init() {
    this._didInit || (vn(_zo), this._didInit = true);
  }
  _initializeBackDrop() {
    return new Cr({
      isVisible: !!this._config.backdrop,
  ...
  _showElement(t) {
    ...
    const o = () => {
      this._config.focus && this._focustrap.trap(), this._isTransitioning = false, c.trigger(this._element, r_, {
        relatedTarget: t
      });
    };
  ...
  _hideModal() {
    ...
    }, e), this._element.setAttribute("aria-hidden", true), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = false, this._backdrop && this._backdrop.hide(() => {
  ...
  static jQueryInterface(t, e) {
    return this.each(function() {
      const i = _zo.getOrCreateInstance(this, t);
      if (typeof t == "string") {
        if (typeof i[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        i[t](e);
...
var $_ = ".popover-header";
var L_ = ".popover-body";
var nh = class _nh extends ri {
  // Getters
  static get Default() {
    return S_;
  }
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      const e = _nh.getOrCreateInstance(this, t);
      if (typeof t == "string") {
        if (typeof e[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        e[t]();
...
var B_ = `activate${yr}`;
var H_ = `scroll${yr}`;
var Gn = "data-te-nav-link-active";
var oh = "[data-te-dropdown-item-ref]";
var V_ = "[data-te-nav-list-ref]";
var Uo = "[data-te-nav-link-ref]";
var W_ = "[data-te-nav-item-ref]";
var rh = "[data-te-list-group-item-ref]";
var qn = `${Uo}, ${rh}, ${oh}`;
var F_ = "[data-te-dropdown-ref]";
var Y_ = "[data-te-dropdown-toggle-ref]";
var j_ = "maxOffset";
var Oa = "position";
var ah = class _ah extends ft {
  constructor(t, e, i) {
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      const e = _ah.getOrCreateInstance(this, t);
      if (typeof t == "string") {
        if (typeof e[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        e[t]();
...
var X_ = `show${Tn}`;
var G_ = `shown${Tn}`;
var q_ = "data-te-dropdown-menu-ref";
var He = "data-te-tab-active";
var Ks = "data-te-nav-active";
var Z_ = "[data-te-dropdown-ref]";
var Q_ = "[data-te-nav-ref]";
var Ia = `[${He}]`;
var J_ = `[${Ks}]`;
var Da = ":scope > li > .active";
var tf = "[data-te-dropdown-toggle-ref]";
var ef = ":scope > [data-te-dropdown-menu-ref] [data-te-dropdown-show]";
var sf = {
  show: "opacity-100",
  hide: "opacity-0"
};
...
var lh = class _lh extends ft {
  ...
  _transitionComplete(t, e, i, n, o) {
    if (e && n) {
      ...
      a && a.removeAttribute(He), e.getAttribute("role") === "tab" && e.setAttribute("aria-selected", false);
    }
    t.setAttribute(He, ""), o.setAttribute(Ks, ""), t.getAttribute("role") === "tab" && t.setAttribute("aria-selected", true), si(t), t.classList.contains(this._classes.hide) && (h.removeClass(t, this._classes.hide), h.addClass(t, this._classes.show));
    let r = t.parentNode;
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      const e = _lh.getOrCreateInstance(this);
      if (typeof t == "string") {
        if (typeof e[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        e[t]();
...
var uf = `show${ne}`;
var pf = `shown${ne}`;
var $a = "data-te-toast-hide";
var Qn = "data-te-toast-show";
var as = "data-te-toast-showing";
var _f = {
  animation: "boolean",
  autohide: "boolean",
  delay: "number"
...
var Xo = class _Xo extends ft {
  ...
  // Private
  _init() {
    this._didInit || (vn(_Xo), this._didInit = true);
  }
  _getConfig(t) {
    return t = {
      ...La,
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      const e = _Xo.getOrCreateInstance(this, t);
      if (typeof t == "string") {
        if (typeof e[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        e[t](this);
...
var wr = class _wr {
  constructor(t, e) {
    this._element = t, this._animateElement = this._getAnimateElement(), this._isFirstScroll = true, this._repeatAnimateOnScroll = true, this._options = this._getConfig(e), this._element && (A.setData(t, to, this), this._init());
  }
  // Getters
  static get NAME() {
    return Ba;
...
var ei = class _ei {
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      return A.getData(this, ds) ? null : new _ei(this, t);
    });
  }
  static getInstance(t) {
...
var og = class {
  ...
  _updateControlsDisabledState() {
    ...
    ) ? this.nextButton.disabled = true : this.nextButton.disabled = false, Vf(
...
var Ce = (s) => {
  if (s === "")
    return;
  let t, e, i, n;
  return gh(s) ? (t = s.getHours(), n = t, e = s.getMinutes(), t %= 12, n === 0 && t === 0 && (i = "AM"), t = t || 12, i === void 0 && (i = Number(n) >= 12 ? "PM" : "AM"), e = e < 10 ? `0${e}` : e) : ([t, e, i] = R(s, false), n = t, t %= 12, n === 0 && t === 0 && (i = "AM"), t = t || 12, i === void 0 && (i = Number(n) >= 12 ? "PM" : "AM")), {
    hours: t,
    minutes: e,
    amOrPm: i
  };
...
var bs = () => navigator.maxTouchPoints && navigator.maxTouchPoints > 2 && /MacIntel/.test(navigator.platform) || /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
  navigator.userAgent
);
    ...
    c.on(this._document, vs, "", (t) => {
      ...
      if (t.keyCode === we) {
        ...
        if (v && (t.keyCode === ze && (this._isInner = false, h.addStyle(this._hand, {
          ...
          w > 12 ? 1 : w
        ), this._toggleClassActive(this.hoursArray, this._hour, C), this._toggleClassActive(this.innerHours, this._hour, E)), t.keyCode === Ke && (this._isInner = true, h.addStyle(this._hand, {
          height: "21.5%"
        }), this._hour.textContent = this._setHourOrMinute(
          S >= 24 || S === "00" ? 0 : S
...
var Ci = class _Ci {
  ...
  static toggleSidenav() {
    return function(t) {
      ...
      d.find(i).forEach((n) => {
        (_Ci.getInstance(n) || new _Ci(n)).toggle();
      });
    };
  }
  static jQueryInterface(t, e) {
    return this.each(function() {
      ...
      const n = typeof t == "object" && t;
      if (!(!i && /dispose/.test(t)) && (i || (i = new _Ci(this, n)), typeof t == "string")) {
        if (typeof i[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        i[t](e);
      }
  ...
  _bindKeysNavigation() {
    this._toggleStepTabIndex(
      ...
      c.on(e, ul, (i) => {
        ...
        (i.keyCode === it || i.keyCode === Zs) && (i.preventDefault(), this.changeStep(this._steps.indexOf(n))), i.keyCode === ke && (this._toggleStepTabIndex(a, l), this._toggleOutlineStyles(a, false), l.focus());
      }), c.on(e, zg, (i) => {
        const n = d.parents(
          i.currentTarget,
          `${Kt}`
        ...
        i.keyCode === ke && (this._toggleStepTabIndex(o, r), this._toggleOutlineStyles(false, r), r.focus());
      });
    });
  }
...
function hb(s, t, e, i, n) {
  ...
  a.setAttribute(qg, ""), h.addClass(a, i.selectInput), Os(
    ...
    i.selectInputSizeSm,
    i.selectInputSizeLg
  ), t.selectFormWhite && h.addClass(a, i.selectInputWhite), a.setAttribute("type", "text"), a.setAttribute("role", l), a.setAttribute("aria-multiselectable", p), a.setAttribute("aria-disabled", u), a.setAttribute("aria-haspopup", "true"), a.setAttribute("aria-expanded", false), t.tabIndex && a.setAttribute("tabIndex", t.tabIndex), t.disabled && a.setAttribute("disabled", ""), t.selectPlaceholder !== "" && a.setAttribute("placeholder", t.selectPlaceholder), t.selectValidation ? (h.addStyle(a, {
    "pointer-events": "none",
...
var kr = class _kr {
  constructor(t, e, i) {
    this._element = t, this._config = this._getConfig(e), this._classes = this._getClasses(i), this._config.selectPlaceholder && !this._config.multiple && this._addPlaceholderOption(), this._optionsToRender = this._getOptionsToRender(t), this._plainOptions = this._getPlainOptions(this._optionsToRender), this._filteredOptionsList = null, this._selectionModel = new Ug(this.multiple), this._activeOptionIndex = -1, this._activeOption = null, this._wrapperId = et("select-wrapper-"), this._dropdownContainerId = et("select-dropdown-container-"), this._selectAllId = et("select-all-"), this._debounceTimeoutId = null, this._dropdownHeight = this._config.selectOptionHeight * this._config.selectVisibleOptions, this._popper = null, this._input = null, this._label = d.next(this._element, kb)[0], this._notch = null, this._fakeValue = null, this._isFakeValueActive = false, this._customContent = d.next(
      t,
      $b
    )[0], this._toggleButton = null, this._elementToggle = null, this._wrapper = null, this._inputEl = null, this._dropdownContainer = null, this._container = null, this._selectAllOption = null, this._init(), this._mutationObserver = null, this._isOpen = false, this._addMutationObserver(), this._element && A.setData(t, yi, this);
  }
  static get NAME() {
    return mo;
  }
  ...
  _createOptionObject(t, e = {}) {
    const i = et("option-"), n = e.id ? e.id : null, o = e.disabled ? e.disabled : false, r = t.selected || t.hasAttribute(bi), a = t.hasAttribute("disabled") || o, l = t.hasAttribute("hidden") || e && e.hidden, p = this.multiple, u = t.value, _ = t.label, f = h.getDataAttribute(
      t,
      "selectSecondaryText"
  ...
  static jQueryInterface(t, e) {
    return this.each(function() {
      ...
      const n = typeof t == "object" && t;
      if (!(!i && /dispose/.test(t)) && (i || (i = new _kr(this, n)), typeof t == "string")) {
        if (typeof i[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        i[t](e);
      }
...
var Hb = ({ inputID: s, labelText: t }, e) => `<div data-te-chips-input-wrapper data-te-input-wrapper-init class="${e.chipsInputWrapper}">
      <input
          type="text"
          class="${e.chipsInput}"
          id="${s}"
...
var Vb = ({ text: s, iconSVG: t }, e) => `<div data-te-chip-init data-te-ripple-init class="${e.chipElement}">
...
var vo = `[${Oh}]`;
var Fb = "delete.te.chips";
var Yb = "select.te.chip";
var jb = '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3"> <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>';
var Kb = {
  text: "string",
  closeIcon: "boolean",
  img: "object",
...
var nv = `[${iv}]`;
var ov = `[${sv}]`;
var Ne = "data-te-input-state-active";
var Eo = "[data-te-input-notch-ref]";
var rv = "add.te.chips";
var av = "arrowDown.te.chips";
var lv = "arrowLeft.te.chips";
var cv = "arrowRight.te.chips";
var hv = "arrowUp.te.chips";
var Sl = "delete.te.chips";
var Il = "select.te.chips";
var dv = {
  inputID: "string",
...
var XA = class extends vi {
  constructor(e, i = {}, n) {
    super(e, i);
    wt(this, "_handleBlurInput", ({ target: e2 }) => {
      e2.value.length > 0 && this._handleCreateChip(e2, e2.value), this.allChips.length > 0 ? (e2.setAttribute(bt, ""), this.input.setAttribute(Ne, ""), d.findOne(
        Eo,
        this.input.parentNode
      ).setAttribute(Ne, ""), this.chipsInputWrapper.classList.add(
        ...this._classes.inputWrapperPadding.split(" ")
      )) : (e2.removeAttribute(bt), this.input.removeAttribute(Ne), d.findOne(
        Eo,
        this.input.parentNode
      ).removeAttribute(Ne), this.chipsInputWrapper.classList.remove(
        ...this._classes.inputWrapperPadding.split(" ")
      )), this.allChips.forEach((i2) => i2.removeAttribute(bt));
    });
  ...
  _handleKeysInputToElement(e) {
    ...
    if (n.hasAttribute(Jo)) {
      ...
      i === it && (n.contentEditable = false, n.classList.remove(...this._classes.contentEditable.split(" ")), n.textContent !== "" ? setTimeout(() => {
        h.addStyle(o, { display: "block" }), o.classList.remove(...this._classes.opacity.split(" "));
...
var Lh = class _Lh {
  ...
  async _getChartjs() {
    const {
      ...
      Tooltip: O,
      SubTitle: x
    } = await import("./chart.es-FE624B7L.js").then((L) => L.f);
    return t.register(
      e,
      i,
      n,
  ...
  async _getChartDataLabels() {
    return await import("./chartjs-plugin-datalabels.es-TAO3ZPJL.js");
  }
...
var xr = class _xr {
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      ...
      if (!(!e && /dispose|hide/.test(t)) && (e || (e = new _xr(this, i)), typeof t == "string")) {
        if (typeof e[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        e[t]();
      }
...
var Bh = xr;
var Xv = "data-te-datatable-select-ref";
var Gv = "data-te-datatable-pagination-nav-ref";
var qv = "data-te-datatable-pagination-right-ref";
var Zv = "data-te-datatable-pagination-left-ref";
var Qv = "data-te-datatable-pagination-start-ref";
var Jv = "data-te-datatable-pagination-end-ref";
var tT = ({
  text: s,
  entries: t,
  entriesOptions: e,
...
var eT = "data-te-datatable-sort-icon-ref";
var iT = "data-te-datatable-header-checkbox-ref";
var sT = (s, t, e, i, n, o, r, a) => {
  const l = e ? `
  <th scope="col">
...
var nT = "data-te-datatable-row-ref";
var oT = "data-te-datatable-row-checkbox-ref";
var rT = "data-te-datatable-cell-ref";
var aT = ({
  rows: s,
  columns: t,
  noFoundMessage: e,
...
var lT = "data-te-datatable-inner-ref";
var cT = "data-te-datatable-header-ref";
var Pl = ({
  columns: s,
  rows: t,
  noFoundMessage: e,
...
var hT = ({ rows: s, field: t, order: e }) => s.sort((n, o) => {
  let r = n[t], a = o[t];
...
var Bl = ({ rows: s, entries: t, activePage: e }) => {
  const i = e * t;
...
var CT = `rowClick${An}`;
var AT = `update${An}`;
var yT = `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 10.5L12 3m0 0l7.5 7.5M12 3v18" />
</svg>`;
var wT = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M18.75 19.5l-7.5-7.5 7.5-7.5m-6 15L5.25 12l7.5-7.5" />
</svg>`;
var kT = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
</svg>`;
var xT = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
</svg>`;
var OT = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5"/>
</svg>`;
var ST = "border-neutral-200 dark:border-neutral-500";
var IT = "border-none";
var DT = "relative float-left -ml-[1.5rem] mr-[6px] mt-[0.15rem] h-[1.125rem] w-[1.125rem] appearance-none rounded-[0.25rem] border-[0.125rem] border-solid border-neutral-300 outline-none before:pointer-events-none before:absolute before:h-[0.875rem] before:w-[0.875rem] before:scale-0 before:rounded-full before:bg-transparent before:opacity-0 before:shadow-[0px_0px_0px_13px_transparent] before:content-[''] checked:border-primary checked:bg-primary checked:before:opacity-[0.16] checked:after:absolute checked:after:-mt-px checked:after:ml-[0.25rem] checked:after:block checked:after:h-[0.8125rem] checked:after:w-[0.375rem] checked:after:rotate-45 checked:after:border-[0.125rem] checked:after:border-l-0 checked:after:border-t-0 checked:after:border-solid checked:after:border-white checked:after:bg-transparent checked:after:content-[''] hover:cursor-pointer hover:before:opacity-[0.04] hover:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:shadow-none focus:transition-[border-color_0.2s] focus:before:scale-100 focus:before:opacity-[0.12] focus:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:before:transition-[box-shadow_0.2s,transform_0.2s] focus:after:absolute focus:after:z-[1] focus:after:block focus:after:h-[0.875rem] focus:after:w-[0.875rem] focus:after:rounded-[0.125rem] focus:after:content-[''] checked:focus:before:scale-100 checked:focus:before:shadow-[0px_0px_0px_13px_#3b71ca] checked:focus:before:transition-[box-shadow_0.2s,transform_0.2s] checked:focus:after:-mt-px checked:focus:after:ml-[0.25rem] checked:focus:after:h-[0.8125rem] checked:focus:after:w-[0.375rem] checked:focus:after:rotate-45 checked:focus:after:rounded-none checked:focus:after:border-[0.125rem] checked:focus:after:border-l-0 checked:focus:after:border-t-0 checked:focus:after:border-solid checked:focus:after:border-white checked:focus:after:bg-transparent dark:border-neutral-600 dark:checked:border-primary dark:checked:bg-primary dark:focus:before:shadow-[0px_0px_0px_13px_rgba(255,255,255,0.4)] dark:checked:focus:before:shadow-[0px_0px_0px_13px_#3b71ca] dark:border-neutral-400";
var $T = "mb-[0.125rem] min-h-[1.5rem] pl-[1.5rem] ml-3 flex items-center";
var LT = "relative float-left -ml-[1.5rem] mr-[6px] mt-[0.15rem] h-[1.125rem] w-[1.125rem] appearance-none rounded-[0.25rem] border-[0.125rem] border-solid border-neutral-300 outline-none before:pointer-events-none before:absolute before:h-[0.875rem] before:w-[0.875rem] before:scale-0 before:rounded-full before:bg-transparent before:opacity-0 before:shadow-[0px_0px_0px_13px_transparent] before:content-[''] checked:border-primary checked:bg-primary checked:before:opacity-[0.16] checked:after:absolute checked:after:-mt-px checked:after:ml-[0.25rem] checked:after:block checked:after:h-[0.8125rem] checked:after:w-[0.375rem] checked:after:rotate-45 checked:after:border-[0.125rem] checked:after:border-l-0 checked:after:border-t-0 checked:after:border-solid checked:after:border-white checked:after:bg-transparent checked:after:content-[''] hover:cursor-pointer hover:before:opacity-[0.04] hover:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:shadow-none focus:transition-[border-color_0.2s] focus:before:scale-100 focus:before:opacity-[0.12] focus:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:before:transition-[box-shadow_0.2s,transform_0.2s] focus:after:absolute focus:after:z-[1] focus:after:block focus:after:h-[0.875rem] focus:after:w-[0.875rem] focus:after:rounded-[0.125rem] focus:after:content-[''] checked:focus:before:scale-100 checked:focus:before:shadow-[0px_0px_0px_13px_#3b71ca] checked:focus:before:transition-[box-shadow_0.2s,transform_0.2s] checked:focus:after:-mt-px checked:focus:after:ml-[0.25rem] checked:focus:after:h-[0.8125rem] checked:focus:after:w-[0.375rem] checked:focus:after:rotate-45 checked:focus:after:rounded-none checked:focus:after:border-[0.125rem] checked:focus:after:border-l-0 checked:focus:after:border-t-0 checked:focus:after:border-solid checked:focus:after:border-white checked:focus:after:bg-transparent dark:border-neutral-600 dark:checked:border-primary dark:checked:bg-primary dark:focus:before:shadow-[0px_0px_0px_13px_rgba(255,255,255,0.4)] dark:checked:focus:before:shadow-[0px_0px_0px_13px_#3b71ca] dark:border-neutral-400";
var NT = "mb-[0.125rem] min-h-[1.5rem] pl-[1.5rem] ml-3 flex items-center";
var MT = "bg-white dark:bg-neutral-800";
var RT = "py-4 pl-1 text-clip overflow-hidden text-[#212529] dark:text-white";
var PT = "focus:outline-none";
var BT = "sticky top-0 z-30";
var HT = "sticky z-10 bg-inherit";
var VT = "hover:bg-neutral-100 dark:hover:bg-neutral-700";
var WT = "pointer-events-none cursor-none text-neutral-400 dark:text-neutral-300";
var FT = "h-[2px] relative w-full overflow-hidden";
var YT = "text-center text-neutral-500 font-ligh text-sm my-4 dark:text-neutral-400";
var jT = "text-neutral-500 dark:text-neutral-300";
var KT = "text-neutral-500 dark:text-neutral-300";
var zT = "pointer-events-none cursor-none";
var UT = "h-full w-[45%] bg-primary-400 dark:bg-primary-600";
var XT = "h-full animate-[progress_3s_ease-in-out_infinite]";
var GT = "pl-2 py-3 font-light text-sm dark:text-neutral-300";
var qT = "border-b";
var ZT = "flex md:flex-row justify-end items-center py-2 space-x-4 text-sm flex-col leading-[1.6]";
var QT = "border border-t-0";
var JT = "order-1 my-3 md:order-none md:my-0 md:pr-1";
var tE = "inline-block rounded p-2.5 text-xs font-medium uppercase leading-normal transition duration-150 ease-in-out hover:bg-neutral-100 hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 disabled:text-slate-300 disabled:hover:bg-transparent dark:hover:bg-neutral-500 dark:disabled:hover:bg-transparent dark:disabled:text-neutral-600";
var eE = "inline-block rounded p-2.5 font-medium uppercase leading-normal transition duration-150 ease-in-out hover:bg-neutral-100 hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 disabled:text-slate-300 disabled:hover:bg-transparent dark:hover:bg-neutral-500 dark:disabled:hover:bg-transparent dark:disabled:text-neutral-600";
var iE = "font-normal order-2 mb-3 md:order-none md:mb-0";
var sE = "inline-block rounded p-2.5 font-medium uppercase leading-normal transition duration-150 ease-in-out hover:bg-neutral-100 hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 disabled:text-slate-300 disabled:hover:bg-transparent dark:hover:bg-neutral-500 dark:disabled:hover:bg-transparent dark:disabled:text-neutral-600";
var nE = "font-light";
var oE = "inline-block rounded p-2.5 font-medium uppercase leading-normal transition duration-150 ease-in-out hover:bg-neutral-100 hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 disabled:text-slate-300 disabled:hover:bg-transparent dark:hover:bg-neutral-500 dark:disabled:hover:bg-transparent dark:disabled:text-neutral-600";
var rE = "border-b";
var aE = "transition ease-in-out duration-300 motion-reduce:transition-none";
var lE = "whitespace-nowrap text-clip overflow-auto px-[1.4rem] py-4";
var cE = "relative";
var hE = "!bg-neutral-100 dark:!bg-neutral-600";
var dE = "flex items-center space-x-4 order-3 md:order-none";
var uE = "w-[70px]";
var pE = "!py-2";
var _E = "w-[15px] h-[10px] origin-bottom font-black mr-1 opacity-0 text-neutral-500 group-hover:opacity-100 transition hover:ease-in-out transform ease-linear duration-300 motion-reduce:transition-none dark:text-neutral-400";
var fE = "flex flex-row group";
var mE = "[&:nth-child(odd)]:bg-neutral-50 [&:nth-child(odd)]:dark:bg-neutral-700";
var gE = "border";
var bE = "border-b font-normal px-[1.4rem]";
var vE = "text-left text-sm font-light w-full leading-[1.6]";
var TE = {
  bordered: "boolean",
  borderless: "boolean",
...
var Hh = class _Hh {
  ...
  static jQueryInterface(t, e, i) {
    return this.each(function() {
      ...
      if (!(!n && /dispose/.test(t)) && (n || (n = new _Hh(this, o, e)), typeof t == "string")) {
        if (typeof n[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        n[t](e, i);
      }
...
var Vl = "rating";
var sn = "te.rating";
var kE = "data-te-rating-init";
var xE = "[data-te-rating-icon-ref]";
var ci = `.${sn}`;
var OE = "ArrowLeft";
var SE = "ArrowRight";
var IE = {
...
var LE = `cancel${Vh}`;
var NE = `confirm${Vh}`;
var ME = "[data-te-popconfirm-body]";
var So = "data-te-popconfirm-popover";
var RE = "data-te-popconfirm-modal";
var zl = "data-te-popconfirm-backdrop";
var PE = {
...
var Wh = class _Wh {
  constructor(t, e, i) {
    this._element = t, this._options = this._getConfig(e), this._classes = this._getClasses(i), this._popper = null, this._cancelButton = "", this._confirmButton = "", this._isOpen = false, this._uid = this._element.id ? `popconfirm-${this._element.id}` : et("popconfirm-"), t && A.setData(t, xi, this), this._clickHandler = this.open.bind(this), c.on(this._element, "click", this._clickHandler);
  }
  // Getters
  static get NAME() {
    return Oo;
  ...
  _openModal(t) {
    const e = $("div");
    e.setAttribute(zl, ""), h.addClass(e, this._classes.backdrop), document.body.appendChild(e), e.appendChild(t), h.addClass(this.popconfirmBody, "opacity-100"), this._isOpen = true;
  }
...
var Ul = "data-te-lightbox-caption";
var jE = "data-te-lightbox-disabled";
var Dt = "data-te-lightbox-active";
var KE = `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 12h-15m0 0l6.75 6.75M4.5 12l6.75-6.75" />
</svg>
`;
var zE = `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75" />
</svg>
`;
var UE = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15" />
</svg>
`;
var XE = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 9V4.5M9 9H4.5M9 9L3.75 3.75M9 15v4.5M9 15H4.5M9 15l-5.25 5.25M15 9h4.5M15 9V4.5M15 9l5.25-5.25M15 15h4.5M15 15v4.5m0-4.5l5.25 5.25" />
</svg>
`;
var GE = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607zM10.5 7.5v6m3-3h-6" />
</svg>
`;
var qE = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-4 h-4">
<path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607zM13.5 10.5h-6" />
</svg>
`;
var ZE = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-4 h-4">
...
var nn = class _nn {
  ...
  toggleFullscreen() {
    this._fullscreen === false ? (this._fullscreenBtn.setAttribute(Dt, ""), this._fullscreenBtn.innerHTML = this.options.hideFullscreenIconTemplate, this._gallery.requestFullscreen && this._gallery.requestFullscreen(), this._fullscreen = true) : (this._fullscreenBtn.removeAttribute(Dt), document.exitFullscreen && document.exitFullscreen(), this._fullscreen = false);
  }
  reset() {
  ...
  _onFullscreenChange() {
    (document.webkitIsFullScreen || document.mozFullScreen || document.msFullscreenElement) === void 0 && (this._fullscreen = false, this._fullscreenBtn.innerHTML = this.options.showFullscreenIconTemplate, this._fullscreenBtn.removeAttribute(Dt));
  }
  _beforeSlideEvents() {
  ...
  static toggle() {
    return function(t) {
      ...
      (_nn.getInstance(e) || new _nn(e)).open(t);
    };
  }
  static jQueryInterface(t, e) {
    return this.each(function() {
      ...
      const n = typeof t == "object" && t;
      if (!(!i && /dispose/.test(t)) && (i || (i = new _nn(this, n)), typeof t == "string")) {
        if (typeof i[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        i[t](e);
      }
...
var jh = class _jh extends ft {
  constructor(t, e, i) {
    super(t), this._element = t, this._element && A.setData(t, ir, this), this._config = this._getConfig(e), this._classes = this._getClasses(i), this._isValid = true, this._shouldApplyInputEvents = true, this._submitCallback = null, this._errorMessages = {
      ...i0,
  ...
  _handleValidation() {
    this._element.getAttribute(Ls) && (this._validationResult = [], this._isValid = true, this._validationElements.forEach(
  ...
  _validateSingleElement(t) {
    ...
    i === "input" && this._restyleNotches(e, l), i === "basic" && this._restyleBasicInputs(n, l), (i === "checkbox" || i === "radio") && this._restyleCheckboxes(n, l, i), this._restyleLabels(e, l), a === "invalid" && (this._isValid = false), this._config.disableFeedback || this._applyFeedback(e, a), c.trigger(this._element, d0, {
      value: {
        name: r,
        result: a,
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      const e = _jh.getOrCreateInstance(this);
      if (typeof t == "string") {
        if (e[t] === void 0 || t.startsWith("_") || t === "constructor")
          throw new TypeError(`No method named "${t}"`);
        e[t](this);
...
var Kh = class _Kh {
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      ...
      const i = typeof t == "object" && t;
      if (!(!e && /dispose/.test(t)) && (e || (e = new _Kh(this, i)), typeof t == "string")) {
        if (typeof e[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        return e[t];
      }
...
var zh = class _zh {
  constructor(t, e = {}) {
    this._element = t, this._options = this._getConfig(e), this._href = this._element.getAttribute("href"), this.isCancel = false, this._element && (A.setData(t, Si, this), this._setup());
  }
  // getters
  static get NAME() {
    return nr;
  ...
  _handleClick(t) {
    t.preventDefault(), this.isCancel = false, c.trigger(this._element, G0);
  ...
  _scrollOnNextTick(t, e, i, n, o, r, a) {
    ...
    if (l || p || u || this.isCancel) {
      if (this.isCancel) {
        this.isInViewport && (this.isCancel = false), c.trigger(this._element, Z0);
        return;
      }
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      ...
      const i = typeof t == "object" && t;
      if (e || (e = new _zh(this, i)), typeof t == "string") {
        if (typeof e[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        e[t](this);
      }
...
var ql = "lazyLoad";
var Ps = "te.lazyLoad";
var Q0 = "[data-te-lazy-load-init]";
var Zl = "data-te-lazy-load";
var J0 = "onLoad.te.lazy";
var tC = "onError.te.lazy";
var Ql = ["img", "video"];
var eC = {
  lazySrc: "(string|null)",
  lazyDelay: "number",
...
var or = class _or {
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      ...
      const i = typeof t == "object" && t;
      if (e || (e = new _or(this, i)), typeof t == "string") {
        if (typeof e[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        e[t](this);
      }
...
var Uh = class _Uh {
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      ...
      const i = typeof t == "object" && t;
      if (e || (e = new _Uh(this, i)), typeof t == "string") {
        if (typeof e[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        e[t](this);
      }
...
var Hs = `te.${Fi}`;
var hC = "[data-te-loading-icon-ref]";
var dC = "[data-te-loading-text-ref]";
var uC = `show.te.${Fi}`;
var pC = {
...
var Gh = class _Gh {
  ...
  static jQueryInterface(t) {
    return this.each(function() {
      ...
      const i = typeof t == "object" && t;
      if (e || (e = new _Gh(this, i)), typeof t == "string") {
        if (typeof e[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        e[t](this);
      }
...
var bC = (s) => s && Object.prototype.toString.call(s) === "[object Date]" && !isNaN(s);
var vC = (s) => s.getMonth();
var TC = (s) => s.getFullYear();
var EC = (s) => s.match(/[^(dmy)]{1,}/g);
var CC = (s, t, e, i) => {
  let n;
...
var kC = "data-te-datepicker-header";
var xC = "data-te-datepicker-cancel-button-ref";
var OC = "data-te-datepicker-ok-button-ref";
var Ro = "data-te-timepicker-wrapper";
var tc = "data-te-timepicker-cancel";
var SC = "data-te-timepicker-submit";
var IC = "data-te-timepicker-clear";
var ec = "data-te-buttons-timepicker";
var DC = "data-te-date-timepicker-toggle-ref";
var $C = "data-te-datepicker-toggle-button-ref";
var LC = "data-te-timepicker-toggle-button-ref";
var NC = `[${Zh}]`;
var MC = `[${qh}]`;
var RC = `[${DC}]`;
var PC = `[${LC}]`;
var BC = "[data-te-input-notch-ref]";
var HC = "[data-te-date-timepicker-toggle-ref]";
var VC = "[data-te-timepicker-elements-wrapper]";
var WC = "[data-te-timepicker-clock-wrapper]";
var FC = `open${Sr}`;
var YC = `close${Sr}`;
var jC = `datetimeChange${Sr}`;
var ic = "close.te.datepicker";
var sc = "input.te.timepicker";
var Re = $("div");
var nc = {
  inline: false,
  toggleButton: true,
...
var Qh = class _Qh {
  constructor(t, e, i) {
    this._element = t, this._input = d.findOne("input", this._element), this._options = this._getConfig(e), this._classes = this._getClasses(i), this._timepicker = null, this._datepicker = null, this._dateValue = this._options.defaultDate ? this._options.defaultDate : "", this._timeValue = this._options.defaultTime ? this._options.defaultTime : "", this._isInvalidTimeFormat = false, this._format = this._options.datepicker.format ? this._options.datepicker.format : "dd/mm/yyyy", this._cancel = false, this._scrollBar = new ti(), this._element && A.setData(t, Di, this), this._init();
  }
  // Getters
  static get NAME() {
    return on;
  ...
  _addDatepicker() {
    ...
    (this._options.inline || this._options.datepicker.inline) && (i = { ...i, inline: true }), this._datepicker = new og(t, i, {
  ...
  _addTimePicker() {
    ...
    (this._options.inline || this._options.timepicker.inline) && (i = { ...i, inline: true }), this._timepicker = new Sg(t, i, {
  ...
  _openDatePicker() {
    ...
    this._datepicker.open(), this._options.inline || this._scrollBar.hide(), (this._options.inline || this._options.datepicker.inline) && this._openDropdownDate(), this._addIconButtons(), this._listenToCancelClick(), this._options.inline && this._datepicker._isOpen && h.addClass(this.toggleButton, "pointer-events-none"), c.one(this._datepicker._element, ic, () => {
      ...
      c.on(this._datepicker.container, "click", (n) => {
        !this._datepicker._selectedDate && n.target.hasAttribute(OC) || i || (this._openTimePicker(), i = true, setTimeout(() => {
          i = false;
        }, 500));
      }), setTimeout(() => {
        d.findOne(
  ...
  static jQueryInterface(t, e) {
    return this.each(function() {
      ...
      const n = typeof t == "object" && t;
      if (!(!i && /dispose/.test(t)) && (i || (i = new _Qh(this, n)), typeof t == "string")) {
        if (typeof i[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        i[t](e);
      }
...
var td = class _td {
  ...
  _enableSticky() {
    ...
    t !== "" && this._toggleClass(
      ...
      zIndex: `${o}`,
      position: "fixed"
    }), this._hiddenElement.hidden = false, c.trigger(this._element, XC);
  }
  ...
  static jQueryInterface(t, e) {
    return this.each(function() {
      ...
      const n = typeof t == "object" && t;
      if (!(!i && /dispose|hide/.test(t)) && (i || (i = new _td(this, n)), typeof t == "string")) {
        if (typeof i[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        i[t](e);
      }
...
var tA = "data-te-autocomplete-dropdown-ref";
var eA = "data-te-autocomplete-items-list-ref";
var iA = "data-te-autocomplete-item-ref";
var sA = "data-te-autocomplete-loader-ref";
function nA(s, t) {
...
var Pe = "data-te-input-state-active";
var Bo = "data-te-autocomplete-item-active";
var oc = "data-te-input-focused";
var rc = "data-te-autocomplete-state-open";
var aA = "data-te-autocomplete-custom-content-ref";
var lA = "[data-te-autocomplete-dropdown-ref]";
var Vs = "[data-te-autocomplete-items-list-ref]";
var ac = "[data-te-autocomplete-item-ref]";
var cA = "[data-te-autocomplete-loader-ref]";
var hA = `[${aA}]`;
var dA = "[data-te-input-notch-ref]";
var wn = `.${Li}`;
var uA = `close${wn}`;
var pA = `open${wn}`;
...
var id = class _id {
  constructor(t, e, i) {
    this._element = t, this._options = this._getConfig(e), this._classes = this._getClasses(i), this._getContainer(), this._input = d.findOne("input", t), this._notch = d.findOne(dA, t), this._customContent = d.findOne(
      hA,
      t
    ), this._loader = oA(this._classes), this._popper = null, this._debounceTimeoutId = null, this._loaderTimeout = null, this._activeItemIndex = -1, this._activeItem = null, this._filteredResults = null, this._lastQueryValue = null, this._canOpenOnFocus = true, this._isOpen = false, this._outsideClickHandler = this._handleOutsideClick.bind(this), this._inputFocusHandler = this._handleInputFocus.bind(this), this._userInputHandler = this._handleUserInput.bind(this), this._keydownHandler = this._handleKeydown.bind(this), t && A.setData(t, Li, this), this._init();
  }
  static get NAME() {
    return Po;
  }
  ...
  _setInputAriaAttributes() {
    this._input.setAttribute("role", "combobox"), this._input.setAttribute("aria-expanded", false), this._input.setAttribute("aria-owns", this._dropdownContainerId), this._input.setAttribute("aria-haspopup", true), this._input.setAttribute("autocomplete", "off");
  }
  _updateInputState() {
    var t, e;
  ...
  open() {
    ...
    this._isOpen || t.defaultPrevented || (this._updateDropdownWidth(), this._listenToWindowResize(), this._popper = se(this._element, this._dropdownContainer, {
      ...
      this.dropdown.setAttribute(rc, ""), this._isOpen = true, this._setInputActiveStyles(), this._updateInputState();
    }, 0));
  }
  _listenToOutsideClick() {
  ...
  _selectActiveItem() {
    ...
    c.trigger(this._element, lc, {
      ...
      this._canOpenOnFocus = false, this._updateInputValue(e), this._updateInputState();
    }, 0);
  }
  _handleSelection(t) {
    ...
    t !== void 0 && (i.defaultPrevented || setTimeout(() => {
      this._canOpenOnFocus = false, this._updateInputValue(e), this._updateInputState(), this._input.focus(), this.close();
    }, 0));
  }
  _updateInputValue(t) {
    this._input.value = t;
  ...
  _handleDropdownTransitionEnd(t) {
    this._isOpen && t && t.propertyName === "opacity" && (this._popper.destroy(), this._dropdownContainer && this._container.removeChild(this._dropdownContainer), this._isOpen = false, c.off(this.dropdown, "transitionend"), this._canOpenOnFocus = true);
  }
  dispose() {
  ...
  static jQueryInterface(t, e) {
    return this.each(function() {
      ...
      const n = typeof t == "object" && t;
      if (!(!i && /dispose/.test(t)) && (i || (i = new _id(this, n)), typeof t == "string")) {
        if (typeof i[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        i[t](e);
      }
...
var vA = (s, t) => `<div class="${s.connectContainer}" ${t}>
  <div class="${s.connect}"></div>
  </div>`;
var TA = (s, t) => `<div class="${s.hand}" ${t}>
    <span></span>
  </div>`;
var EA = (s, t) => `
    ...
    `;
var pe = (s) => s.type === "touchmove" ? s.touches[0].clientX : s.clientX;
var an = "multiRangeSlider";
var ln = `te.${an}`;
var CA = `.${ln}`;
var cc = `valueChanged${CA}`;
var _e = "data-te-active";
var hc = "data-te-multi-range-slider-hand-ref";
var dc = "data-te-multi-range-slider-connect-ref";
var uc = "data-te-multi-range-slider-tooltip-ref";
var AA = {
  max: "number",
  min: "number",
...
var sd = class _sd extends ft {
  constructor(t, e, i) {
    super(t), this._options = this._getConfig(e), this._mousemove = false, this._classes = this._getClasses(i), this._maxTranslation = null, this._minTranslation = null, this._currentStepValue = null, this._canChangeStep = false, this.init();
  }
  // Getters
  static get NAME() {
    return an;
  ...
  _handleClickEventOnHand() {
    ...
    this.hands.forEach((n) => {
      K.on(n, "mousedown touchstart", (o) => {
        if (this._mousemove = true, n.setAttribute(_e, ""), this._options.tooltip && n.children[1].setAttribute(_e, ""), this._handleMoveEvent(n), this._handleEndMoveEvent(n, o), !this._canChangeStep && i !== null)
          return;
  ...
  _handleEndMoveEventDocument() {
    K.on(document, "mouseup touchend", () => {
      ...
      }), K.off(document, "mousemove touchmove"), this._mousemove = false);
    });
  }
  _handleEndMoveEvent(t) {
    K.on(t, "mouseup touchend", () => {
      this._resetHandState(t, "mousemove"), K.off(document, "mousemove touchmove"), this._mousemove = false;
    });
  }
  _handleClickOnRange() {
  ...
  static jQueryInterface(t, e) {
    return this.each(function() {
      ...
      const n = typeof t == "object" && t;
      if (!(!i && /dispose|hide/.test(t)) && (i || (i = new _sd(this, n)), typeof t == "string")) {
        if (typeof i[t] > "u")
          throw new TypeError(`No method named "${t}"`);
        i[t](e);
      }

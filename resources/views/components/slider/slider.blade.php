<section class="slider mt-10 w-full  h-auto flex flex-col items-center max-md:hidden">
    <div class="slideshow-container flex justify-center w-full px-[384px] h-[574px]">
        ...
        <a class="prev absolute top-1/2 cursor-pointer left-[384px] text-[#0D3C99] text-[24px] max-md:text-[11px]" onclick="plusSlides(-1)">❮</a>
        <a class="next max-md:text-[11px] absolute cursor-pointer top-1/2 right-[384px] text-[#0D3C99] text-[24px]" onclick="plusSlides(1)">❯</a>
